...
const Index = () => {
  ...
  const { user, isAuthenticated, registerUser, loading, setLoading } =
    useUser();
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>
          Object Tracker | Real-time Object Detection in Adverse Weather
        </title>
      </Helmet>
      ...
      <section className="relative pt-20 overflow-hidden">
        <div
          className={`absolute inset-0 -z-10 ${
            isDark ? "hero-bg-dark" : "hero-bg-light"
          }`}
        ></div>
        ...
        <div className="container px-4 py-20 md:py-32">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            <Badge
              variant="outline"
              className="mb-4 px-3 py-1 text-sm bg-background/80 backdrop-blur-sm"
            >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mb-8 animate-slide-in-up [animation-delay:200ms]">
              Track and detect objects in challenging weather conditions like
              fog, rain, and dust with precision and reliability. Powered by
        ...
        <div className="container px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground">
              Our object detection system is built to perform in the most
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center justify-between max-w-6xl mx-auto p-8 glass-card">
            <div className="md:max-w-md">
              <h2 className="text-2xl font-bold mb-4">
                Start Using Object Tracker Today
              </h2>
